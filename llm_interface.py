...
class OpenAIProvider(LLMProvider):
    ...
    async def initialize(self) -> bool:
        ...
        Returns:
            bool: True if the provided key is a valid OpenAI Key, False otherwise
        """
        try:
    ...
    async def validate_api_key(self) -> bool:
        ...
        Returns:
            bool: True if OpenAI client model list is served, false otherwise
        """
        try:
    ...
    async def generate_response(
        ...
        Args:
            input_text (str): The input text/prompt for the LLM
            instructions (str): System instructions/prompt
            temperature (float): Sampling temperature (0.0 to 1.0)
            max_tokens (Optional[int]): Maximum tokens in response
            tools (Optional[List[LLMTool]]): Optional list of tools for function calling
        
        Returns:
            LLMResponse: Standardized response object generated by OpenAI
        """
        try:
            messages = [
...
class GeminiProvider(LLMProvider):
    ...
    async def initialize(self) -> bool:
        ...
        Returns:
            bool: True if the provided key is a valid Gemini Key, False otherwise
        """
        try:
    ...
    async def validate_api_key(self) -> bool:
        ...
        Returns:
            bool: True if Gemini client test generation is successful, false otherwise    
        """
        try:
    ...
    async def generate_response(
        ...
        Returns:
            LLMResponse: Standardized response object generated by Gemini
        """
        try:
